export namespace Bitburner {
  ...
  export function getAugmentationsByEffect(effectType: keyof AugmentationMultipliers, minMultiplier: number = 1): AugmentationData[] {
  ...
  export function getAugmentationsByCategory(category: "hacking" | "combat" | "social" | "hacknet" | "bladeburner" | "crime"): AugmentationData[] {
