import type { Bitburner as BitburnerTypes } from "../types";
...
export const AUGMENTATION_DATA: Record<string, BitburnerTypes.AugmentationData> = {
  ADRPheromone1: {
...
export function getAugmentationsByEffect(
  effectType: keyof BitburnerTypes.AugmentationMultipliers,
  minMultiplier: number = 1
): BitburnerTypes.AugmentationData[] {
...
export function getAugmentationsByFaction(factionName: string): BitburnerTypes.AugmentationData[] {
...
export function getAugmentationsByCategory(
  ...
  const categoryFilters: Record<string, (keyof BitburnerTypes.AugmentationMultipliers)[]> = {
