export namespace Bitburner {
  ...
  // Augmentation data structure optimized for filtering by effect type
  ...
  // Data constants populated via bitburner/data modules (placeholder defaults overwritten in index.ts)
  export const ALL_COMPANIES: readonly string[] = [];
  export const ALL_JOB_TITLES: readonly string[] = [];
  export const COMPANY_JOBS: Record<string, readonly string[]> = {};
  export const ALL_AUGMENTATIONS: readonly string[] = [];
  export const AUGMENTATION_DATA: Record<string, AugmentationData> = {} as Record<string, AugmentationData>;
  export const getAugmentationsByEffect = (
    effectType: keyof AugmentationMultipliers,
    minMultiplier: number = 1
  ): AugmentationData[] => [];
  export const getAugmentationsByFaction = (factionName: string): AugmentationData[] => [];
  export const getAugmentationsByCategory = (
